...
%feature("docstring") gr::cc_sdr::cc_decoder "<+description of block+>"

%feature("docstring") gr::cc_sdr::cc_decoder::make "Return a shared_ptr to a new instance of cc_sdr::cc_decoder.
